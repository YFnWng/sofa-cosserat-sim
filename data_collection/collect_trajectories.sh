...
COLLECT_GENERATOR=sinusoidal COLLECT_DURATION=1800 COLLECT_MATRICES=1 COLLECT_SPEED_FACTOR=5.0 \
COLLECT_DIAGNOSTIC_SOLVER=1 COLLECT_VERBOSE=0 COLLECT_DEBUG=0 COLLECT_A_INTERVAL=10 \
python simulation/scenes/collect_data.py \
